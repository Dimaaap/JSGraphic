class Chart {
    ...
    #drawSamples(){
        ...
        for(const sample of samples){
            const {point} = sample;
            const pixelLoc = [
                math.remap(dataBounds.left, dataBounds.right,
                    pixelBounds.left, pixelBounds.right, point[0]),
                math.remap(dataBounds.top, dataBounds.bottom, 
                    pixelBounds.top, pixelBounds.bottom, point[1])
            ];
